...
const ArticlePage = async ({ params }: ArticlePageProps) => {
  ...
  return (
    <>
      ...
      <article className="bg-background">
        ...
        <div className="mx-auto max-w-[1400px] px-6 py-12 md:px-12 md:py-16 lg:py-20">
          <div className="article-grid grid grid-cols-1 gap-10 md:gap-12 xl:gap-16">
            ...
            <ArticleSidebar
              headings={headings}
              people={article.articlePeople.map((ap) => ({
                name: ap.person.name,
                slug: ap.person.slug,
                tagline: ap.person.tagline,
                jobTitle: ap.person.jobTitle,
                company: ap.person.company,
                description: ap.person.description,
                imageUrl: ap.person.imageUrl,
                linkedinUrl: ap.person.linkedinUrl,
              }))}
      ...
      <ArticleSuggestions articles={relatedArticles} />
    </>
  );
};
